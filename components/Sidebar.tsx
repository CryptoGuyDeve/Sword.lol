...
const Sidebar = ({ username, id }: { username: string; id: string }) => {
  ...
  return (
    <>
      ...
      <div className="hidden md:block w-64 bg-[#121212] text-white p-6 rounded-xl h-full">
          ...
          <div>
            ...
            <AnimatePresence>
              {dropdownOpen && (
                ...
                >
                  <Link href={`/account/${id}`} className="block hover:text-white">
                    Overview
                  </Link>
                  <Link href={`/account/${id}/badges`} className="block hover:text-white">
                    Badges
                  </Link>
        ...
        <div className="mt-16">
          <p className="text-gray-400 text-sm mb-2">Need support?</p>
          <a
        ...
        <div className="mt-6">
          <p className="text-gray-400 text-sm mb-2">Your page</p>
          <Link
            href={`/users/${username}`}
      ...
      <AnimatePresence>
        {isSidebarOpen && (
          <motion.aside
            ...
            className="fixed top-0 left-0 w-64 h-full bg-[#121212] p-6 shadow-lg text-white z-50 md:hidden"
          >
                ...
                <AnimatePresence>
                  {dropdownOpen && (
                    ...
                    >
                      ...
                      <p className="hover:text-white cursor-pointer">Badges</p>
                      <p className="hover:text-white cursor-pointer">Settings</p>
                    </motion.div>
                  )}
                </AnimatePresence>
